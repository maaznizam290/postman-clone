console.log("Welcome to the postman project");
...
// Hide the parametes box initially
  ...
  let string = ` <div class="form-row my-2">
    ...
    <div class="col-md-4">
      <input
        type="text"
        class="form-control"
        id="parameterkeys${addedParamCount + 2}"
        placeholder="Enter parameters  ${addedParamCount + 2} key"
      />
    </div>
    <div class="col-md-4">
      <input
        ...
        placeholder="Enter Parameters ${addedParamCount + 2}  value"
      />
    </div>
...
submit.addEventListener("click", () => {
  ...
  document.getElementById("responsePrism").innerHTML =
    "Your response will be appear here";
  Prism.highlightAll();
  ...
  // If user has used params option instead of json , collect all the
  ...
  // If the request type is get , invoke fetch api to create a post
  if (requestType == "GET")
    fetch(url, {
      method: "GET",
    })
